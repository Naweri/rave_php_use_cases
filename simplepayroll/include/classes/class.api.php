...
require_once('Flutterwave/api/AccountPayment.php');
require_once('Flutterwave/api/Pay.php');
require_once('Flutterwave/api/bvn.php');
require_once('Flutterwave/api/CardPayment.php');
require_once('Flutterwave/api/Transfer.php');
require_once('Flutterwave/api/Ussd.php');
...
class api extends general
{
	...
	public function fundWallet($newamount)
	{
		...
		$secretKey = "FLWSECK-c789df9e4953611f46cc13126e84f006-X";
		$env = "staging";
		$PBFPubKey = "FLWPUBK-3b89b62623a703ab8fbc72741402c011-X"; // we are suppose to pull from a table in our db name eg: "api-key". dont paste ur keys like this. but for the sake of this test, we will be doing the paste. 
	...
	public function singleTransfer($bankcode, $accountno, $amount, $narration)
	{
		...
		$single = new Transfer();
		$result = $single->singleTransfer($PBFPubKey, $secretKey,$env,$array);
